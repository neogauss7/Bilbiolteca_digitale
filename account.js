if (localStorage.getItem('black') == 'true') {
  document.querySelector('.plan').textContent = 'Black'
}
...
elementlist.insertAdjacentHTML("afterbegin", `<div class="box box${i}"><a href="${array[i].slice(9)}"><p style = "font-size: 15px">${Name}</p></a></div><button class="o${i} buttond">
