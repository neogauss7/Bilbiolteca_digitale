...
document.querySelector('.grid-container').insertAdjacentHTML("beforeend", `<a class='n${i}' href="/lezioni${linksP[i]}"
...
for (let i = 0; i< titlesM.length; i++) {
    document.querySelector('.grid-container').insertAdjacentHTML("beforeend", `<a class='n${i}' href="/lezioni${linksM[i]}"
    ><div class="grid-element">
      <div class="photo photodiv">
        <img
